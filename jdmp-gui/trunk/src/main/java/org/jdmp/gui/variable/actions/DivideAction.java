...
public class DivideAction extends VariableAction {
	...
	public DivideAction(JComponent c, Variable v) {
		super(c, v);
		putValue(Action.NAME, "Divide...");
		putValue(Action.SHORT_DESCRIPTION, "Divide all values in this variable");
		putValue(Action.MNEMONIC_KEY, KeyEvent.VK_D);
		putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_D, InputEvent.ALT_DOWN_MASK));
	}

	public Object call() throws MatrixException {
		getVariable().divideBy(2.0);
		return null;
	}
