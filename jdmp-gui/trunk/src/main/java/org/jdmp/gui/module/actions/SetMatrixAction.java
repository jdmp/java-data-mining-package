...
public class SetMatrixAction extends ModuleAction {
	...
	public SetMatrixAction(JComponent c, Module module, int index, Matrix m) {
		super(c, module);
		this.matrix = m;
		this.index = index;
		...
		putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_S, InputEvent.ALT_DOWN_MASK));
	}
