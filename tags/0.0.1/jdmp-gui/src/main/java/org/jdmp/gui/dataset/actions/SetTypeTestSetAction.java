...
public class SetTypeTestSetAction extends DataSetAction {
	...
	public SetTypeTestSetAction(JComponent c, DataSet ds) {
		super(c, ds);
		putValue(Action.NAME, "Test Set");
		putValue(Action.SHORT_DESCRIPTION, "Set Type to Test Set");
		putValue(Action.MNEMONIC_KEY, KeyEvent.VK_E);
		putValue(Action.ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_E, InputEvent.ALT_DOWN_MASK));
	}

	public Object call() {
		getDataSet().setDataSetType(DataSetType.TESTSET);
		return null;
	}
