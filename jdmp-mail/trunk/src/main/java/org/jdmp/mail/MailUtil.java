...
public class MailUtil {
	...
	public static void sendSystemOut(String recipient, String subject, String userName,
			String smtpServer) throws Exception {
		sendMessage(recipient, subject, UJMPSettings.getSystemOut(), userName, smtpServer);
	}

	public static void sendSystemErr(String recipient, String subject, String userName,
			String smtpServer) throws Exception {
		sendMessage(recipient, subject, UJMPSettings.getSystemErr(), userName, smtpServer);
	}

	public static void sendMessage(String recipient, String subject, String text, String userName,
			String smtpServer) throws Exception {
