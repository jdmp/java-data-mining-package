...
import org.jdmp.core.algorithm.basic.Empty;
...
import org.jdmp.core.algorithm.basic.Henon;
import org.jdmp.core.algorithm.basic.Info;
import org.jdmp.core.algorithm.basic.Iris;
import org.jdmp.core.algorithm.basic.List;
...
public abstract class AlgorithmMapping {
	...
	static {
		...
		mapping.put("empty", Empty.class.getName());
		...
		mapping.put("henon", Henon.class.getName());
		mapping.put("info", Info.class.getName());
		mapping.put("iris", Iris.class.getName());
		...
		mapping.put("map", org.jdmp.core.algorithm.basic.Map.class.getName());
		...
		mapping.put("sample", org.jdmp.core.algorithm.basic.Sample.class.getName());
