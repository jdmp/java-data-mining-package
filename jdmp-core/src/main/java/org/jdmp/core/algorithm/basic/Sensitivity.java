...
public class Sensitivity extends AbstractAlgorithm {
	private static final long serialVersionUID = -6760913071366248714L;

	public static final String DESCRIPTION = "target = sensitivity(source)";

	public Sensitivity(Variable... variables) {
		super();
