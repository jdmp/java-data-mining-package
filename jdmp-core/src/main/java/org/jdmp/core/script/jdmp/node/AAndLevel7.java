...
public final class AAndLevel7 extends PLevel7 {
	...
	public AAndLevel7(@SuppressWarnings("hiding") PLevel7 _left_,
			@SuppressWarnings("hiding") TAnd _and_, @SuppressWarnings("hiding") PLevel6 _right_) {
		// Constructor
		setLeft(_left_);
	...
	public Object clone() {
		return new AAndLevel7(cloneNode(this._left_), cloneNode(this._and_),
