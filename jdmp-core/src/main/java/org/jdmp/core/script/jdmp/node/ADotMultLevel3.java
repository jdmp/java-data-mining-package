...
public final class ADotMultLevel3 extends PLevel3 {
	...
	public ADotMultLevel3(@SuppressWarnings("hiding") PLevel3 _left_,
	...
	public Object clone() {
		return new ADotMultLevel3(cloneNode(this._left_), cloneNode(this._dotMult_),
	...
	public String toString() {
		return "" + toString(this._left_) + toString(this._dotMult_) + toString(this._right_);
	}
