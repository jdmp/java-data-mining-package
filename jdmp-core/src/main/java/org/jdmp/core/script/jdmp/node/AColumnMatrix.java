...
public final class AColumnMatrix extends PMatrix {
	...
	public AColumnMatrix(@SuppressWarnings("hiding") TLBracket _lBracket_,
	...
	public Object clone() {
		return new AColumnMatrix(cloneNode(this._lBracket_), cloneNode(this._column_),
	...
	public String toString() {
		return "" + toString(this._lBracket_) + toString(this._column_) + toString(this._rBracket_);
	}
