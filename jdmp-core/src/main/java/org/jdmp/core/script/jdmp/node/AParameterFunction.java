...
public final class AParameterFunction extends PFunction {
	...
	public AParameterFunction(@SuppressWarnings("hiding") PName _name_,
	...
	public Object clone() {
		return new AParameterFunction(cloneNode(this._name_), cloneNode(this._lParenthese_),
				cloneNode(this._argumentList_), cloneNode(this._rParenthese_));
	}
	...
	public String toString() {
		return "" + toString(this._name_) + toString(this._lParenthese_)
				+ toString(this._argumentList_) + toString(this._rParenthese_);
	}
