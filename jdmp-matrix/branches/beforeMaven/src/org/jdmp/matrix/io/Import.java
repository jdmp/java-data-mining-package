...
public abstract class Import {
	...
	public static Matrix importFromFile(File file, Object... parameters) throws MatrixException {
		return importFromFile(Format.CSV, file, parameters);
	}

	public static Matrix importFromFile(Format format, File file, Object... parameters) throws MatrixException {
		switch (format) {
		case CSV:
			return ImportCSV.importFromCSV(file, parameters);
		case XLS:
	...
	public static Matrix linkToFile(Format format, File file, Object... parameters) throws MatrixException, IOException {
		switch (format) {
		case CSV:
	...
	public static Matrix fromString(String string, Object... parameters) {
		return ImportM.fromString(string);
	}
