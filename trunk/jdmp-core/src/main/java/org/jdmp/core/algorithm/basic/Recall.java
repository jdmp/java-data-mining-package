...
public class Recall extends AbstractAlgorithm {
	private static final long serialVersionUID = -3034316223892970828L;

	public static final String DESCRIPTION = "target = recall(source)";

	public Recall(Variable... variables) {
		super();
