...
public final class AComplementLevel2 extends PLevel2 {
	...
	public AComplementLevel2(@SuppressWarnings("hiding") TComplement _complement_,
	...
	public Object clone() {
		return new AComplementLevel2(cloneNode(this._complement_), cloneNode(this._level1_));
	}
