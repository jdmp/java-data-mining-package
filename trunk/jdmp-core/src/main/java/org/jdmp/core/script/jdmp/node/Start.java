...
public final class Start extends Node {
	...
	public Start(@SuppressWarnings("hiding") PScript _pScript_,
	...
	public Object clone() {
		return new Start(cloneNode(this._pScript_), cloneNode(this._eof_));
	}
	...
	public String toString() {
		return "" + toString(this._pScript_) + toString(this._eof_);
	}
}
