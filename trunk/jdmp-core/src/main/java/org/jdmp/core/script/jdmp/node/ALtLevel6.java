...
public final class ALtLevel6 extends PLevel6 {
	...
	public ALtLevel6(@SuppressWarnings("hiding") PLevel6 _left_,
			@SuppressWarnings("hiding") TLt _lt_, @SuppressWarnings("hiding") PLevel5 _right_) {
		// Constructor
		setLeft(_left_);
	...
	public Object clone() {
		return new ALtLevel6(cloneNode(this._left_), cloneNode(this._lt_), cloneNode(this._right_));
	}
