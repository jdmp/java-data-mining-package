...
public final class AArgumentListArgumentList extends PArgumentList {
	...
	public AArgumentListArgumentList(@SuppressWarnings("hiding") PArgumentList _argumentList_,
	...
	public Object clone() {
		return new AArgumentListArgumentList(cloneNode(this._argumentList_),
				cloneNode(this._comma_), cloneNode(this._expression_));
	}
	...
	public String toString() {
		return "" + toString(this._argumentList_) + toString(this._comma_)
