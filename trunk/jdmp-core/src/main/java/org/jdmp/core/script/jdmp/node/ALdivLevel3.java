...
public final class ALdivLevel3 extends PLevel3 {
	...
	public ALdivLevel3(@SuppressWarnings("hiding") PLevel3 _left_,
			@SuppressWarnings("hiding") TLdiv _ldiv_, @SuppressWarnings("hiding") PLevel2 _right_) {
		// Constructor
		setLeft(_left_);
	...
	public Object clone() {
		return new ALdivLevel3(cloneNode(this._left_), cloneNode(this._ldiv_),
