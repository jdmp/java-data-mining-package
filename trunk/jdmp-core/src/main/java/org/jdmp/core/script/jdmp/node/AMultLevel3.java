...
public final class AMultLevel3 extends PLevel3 {
	...
	public AMultLevel3(@SuppressWarnings("hiding") PLevel3 _left_,
			@SuppressWarnings("hiding") TMult _mult_, @SuppressWarnings("hiding") PLevel2 _right_) {
		// Constructor
		setLeft(_left_);
	...
	public Object clone() {
		return new AMultLevel3(cloneNode(this._left_), cloneNode(this._mult_),
